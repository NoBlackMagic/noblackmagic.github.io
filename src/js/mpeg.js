...
(function(){
    ...
    var html =  '<aside class="author-block">' +
                    '<h3>Marco Pegoraro <small>Lead Front End Dev</small></h3>' +
                    '<div>' +
                        '<img src="//noblackmagic.com/assets/images/marco-pegoraro.jpg" alt="Marco Pegoraro" width="80" class="frame left" />' +
                        ...
                        '<p class="clearfix" style="margin-top: 15px;">' +
                            ...
                            ' | ' +
                            '<a href="http://noblackmagic.com" target="_blank">NoBlackMagic.com</a>' +
                        '</p>' +
                    '</div>' +
                '</aside>';
